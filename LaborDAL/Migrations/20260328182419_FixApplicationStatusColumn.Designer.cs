...
namespace LaborDAL.Migrations
{
    ...
    [Migration("20260328182419_FixApplicationStatusColumn")]
    partial class FixApplicationStatusColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LaborDAL.Entities.FileUploadAuditLog", b =>
                {
                    ...
                    b.Property<string>("DetectedThreats")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<long?>("ValidationDurationMs")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LaborDAL.Entities.IDVerification", b =>
                {
                    ...
                    b.Property<bool?>("FaceMatchPassed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LaborDAL.Entities.TaskItem", b =>
                {
                    ...
                    b.Property<bool>("IsCancellationProcessed")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("LastOperationIdempotencyKey")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTimeOffset?>("NoShowDetectedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("WorkerCheckedInAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("LaborDAL.Entities.ChatUsers", b =>
                {
                    ...
                    b.HasOne("LaborDAL.Entities.AppUser", "Receiver")
